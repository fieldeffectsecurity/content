...
def main():
    ...
    try:
        ...
        elif demisto.command() == 'covalence-list-alerts':
            r = list_alerts()
        ...
        elif demisto.command() == 'covalence-list-sensors':
            r = list_sensors()
            results = CommandResults(
        ...
        elif demisto.command() == 'covalence-get-sensor':
            r = get_sensor()
            results = CommandResults(
        ...
        elif demisto.command() == 'covalence-connections-summary-ip':
        ...
        elif demisto.command() == 'covalence-connections-summary-port':
        ...
        elif demisto.command() == 'covalence-list-dns-resolutions':
        ...
        elif demisto.command() == 'covalence-list-internal-networks':
        ...
        elif demisto.command() == 'covalence-set-internal-networks':
        ...
        elif demisto.command() == 'covalence-list-endpoint-agents':
        ...
        elif demisto.command() == 'covalence-find-endpoint-agents-by-user':
        ...
        elif demisto.command() == 'covalence-find-endpoint-agents-by-uuid':
        ...
        elif demisto.command() == 'covalence-search-endpoint-process':
        ...
        elif demisto.command() == 'covalence-search-endpoint-installed-software':
        ...
        elif demisto.command() == 'covalence-list-organizations':
            r = list_org()
            results = CommandResults(
                outputs_prefix='Covalence.EndpointSoftware',
                outputs_key_field='id',
